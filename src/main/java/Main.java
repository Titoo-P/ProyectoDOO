...
public class Main {
    public static void main(String[] args) {
        ...
        sistemaDeReservas.agregarAutobus(new Autobus("001", "Ruta 1", "10:00 AM", 15, 10, 2500, 5000));
        sistemaDeReservas.agregarAutobus(new Autobus("002", "Ruta 2", "12:00 PM", 20, 10, 2700, 5500));
